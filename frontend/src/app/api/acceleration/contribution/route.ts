...
import { ContributionRequestSchema } from '@/api_contracts/acceleration/contributionContracts';
...
export async function POST(request: NextRequest) {
  try {
    ...
    const result = await AccelerationService.generateContributionAreas({
      userId: auth.userId,
